...
export const normaliseWAV: Tool = {
	...
	seo: {
		title: "Normalise WAV loudness to LUFS — free, in your browser | convrtr",
		h1: "Normalise a WAV file's loudness",
		intent:
			"Measure a WAV file's loudness to EBU R128 and adjust it to a target such as -14 LUFS for streaming. Runs entirely in your browser — the audio never leaves your device.",
		faq: [
			{
		...
		related: ["audio/normalise-flac", "audio/trim-wav", "audio/wav-to-mp3"],
	},
};
