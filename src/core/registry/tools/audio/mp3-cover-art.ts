...
export const coverArtMP3: Tool = {
	id: "audio/mp3-cover-art",
	slug: "mp3-cover-art",
	category: "audio",
	kind: "extract",
	...
	seo: {
		title: "Extract cover art from MP3 — free, in your browser | convrtr",
		h1: "Extract cover art from a MP3",
		intent:
			"Pull the embedded album artwork out of a MP3 file as an image. The picture is copied out exactly as it was stored, not re-encoded. Runs entirely in your browser — the file never leaves your device.",
		faq: [
			{
				q: "Is the image re-compressed?",
				a: "No. The artwork sits inside the file's ID3 APIC frame as a complete JPEG or PNG, so extracting it means copying those bytes out unchanged. Re-encoding would visibly degrade an image you are only trying to retrieve — and would do so invisibly, which is worse.",
			},
			{
