...
export const waveformFLAC: Tool = {
	id: "audio/flac-waveform",
	slug: "flac-waveform",
	category: "audio",
	kind: "generate",
	accept: { mime: ["audio/flac", "audio/x-flac"], ext: ["flac"] },
	output: { ext: "png", mime: "image/png" },
	engines: ["waveform:flac"],
	quality: {
	...
	seo: {
		title: "Make a waveform image from FLAC — free, in your browser | convrtr",
		h1: "Draw a waveform from a FLAC file",
		intent:
			"Turn a FLAC file into a waveform image for a thumbnail, slide or article. Runs entirely in your browser — the audio never leaves your device.",
		faq: [
			{
		...
		related: ["audio/wav-waveform", "audio/normalise-flac", "audio/trim-flac"],
	},
};
