...
import { adifToCsvEngine } from "./adif";
import { adxToWavEngine } from "./adx";
import { aiffToWavEngine } from "./aiff";
import { alsToJsonEngine } from "./als";
import { amfToWavEngine } from "./amf";
import { amrToWavEngine } from "./amr";
import { aniToPngEngine } from "./ani";
import { arrowToCsvEngine } from "./arrow";
import { artStudioToPngEngine } from "./artstudio";
import { ascToCsvEngine } from "./asc";
...
import { blpToPngEngine } from "./blp";
import { bpgToPngEngine } from "./bpg";
import { bspToZipEngine } from "./bsp";
import { bupToZipEngine } from "./bup";
import { cafToWavEngine } from "./caf";
import { cb7ToPdfEngine } from "./cb7";
import { cbrToPdfEngine } from "./cbr";
import { cbtToPdfEngine } from "./cbt";
import { cbzToPdfEngine } from "./cbz";
import { cdrToPngEngine } from "./cdr";
import { cgmToSvgEngine } from "./cgm";
import { chmToZipEngine } from "./chm";
import { chrToPngEngine } from "./chr";
import { cifToJsonEngine } from "./cif";
import { clipToPngEngine } from "./clip";
import { cpcToPngEngine } from "./cpc";
import { cueToJsonEngine } from "./cue";
import { curToPngEngine } from "./cur";
import { cwkToMarkdownEngine } from "./cwk";
import { dbfToCsvEngine } from "./dbf";
import { dcmToPngEngine } from "./dcm";
import { ddsToPngEngine } from "./dds";
import { degasToPngEngine } from "./degas";
import { discordToMarkdownEngine } from "./discord";
import { djiToCsvEngine } from "./dji";
import { drawioToSvgEngine } from "./drawio";
import { dsfToWavEngine } from "./dsf";
import { dsmToWavEngine } from "./dsm";
import { dspToWavEngine } from "./dsp";
import { dstToSvgEngine } from "./dst";
import { dtaToZipEngine } from "./dta";
import { dxfToSvgEngine } from "./dxf";
import { emlToTxtEngine } from "./eml";
import { emlxToEmlEngine } from "./emlx";
import { enexToMarkdownEngine } from "./enex";
import { epubToMarkdownEngine } from "./epub";
import { excalidrawToSvgEngine } from "./excalidraw";
import { expToSvgEngine } from "./exp";
...
import { flicToGifEngine } from "./flic";
import { gbToPngEngine } from "./gb";
import { gbrToPngEngine } from "./gbr";
import { gciToJsonEngine } from "./gci";
...
import { imfToWavEngine } from "./imf";
import { ircamToWavEngine } from "./ircam";
import { isoToZipEngine } from "./iso";
import { itToWavEngine } from "./it";
import { iworkPreviewToZipEngine } from "./iwork";
import { jefToSvgEngine } from "./jef";
import { canvasToMarkdownEngine } from "./jsoncanvas";
import { kmlToGeoJsonEngine } from "./kml";
import { kmzToGeoJsonEngine } from "./kmz";
import { koaToPngEngine } from "./koa";
import { kraToPngEngine } from "./kra";
import { latexToMarkdownEngine } from "./latex";
import { ldifToCsvEngine } from "./ldif";
import { lrcToSrtEngine } from "./lrc";
import { lrvToMp4Engine } from "./lrv";
import { lyxToMarkdownEngine } from "./lyx";
import { macpaintToPngEngine } from "./macpaint";
import { manToMarkdownEngine } from "./man";
import { matToZipEngine } from "./mat";
import { mboxToZipEngine } from "./mbox";
...
import { mmapToMarkdownEngine } from "./mmap";
import { mngToPngEngine } from "./mng";
import { mobiToMarkdownEngine } from "./mobi";
import { modToWavEngine } from "./mod";
import { msgToEmlEngine } from "./msg";
import { mtmToWavEngine } from "./mtm";
import { nbToMarkdownEngine } from "./nb";
import { ndsToPngEngine } from "./nds";
import { neoToPngEngine } from "./neo";
import { nfoToHtmlEngine } from "./nfo";
import { nistToWavEngine } from "./nist";
import { nscriptToTxtEngine } from "./nscript";
import { ofxToCsvEngine } from "./ofx";
import { oktToWavEngine } from "./okt";
import { opmlToMarkdownEngine } from "./opml";
import { oraToPngEngine } from "./ora";
...
import { parquetToCsvEngine } from "./parquet";
...
import { pltToSvgEngine } from "./plt";
import { ppmToPngEngine } from "./ppm";
import { procreateToMp4Engine, procreateToPngEngine } from "./procreate";
import { psdToPngEngine } from "./psd";
import { psuToZipEngine } from "./psu";
import { mcrToZipEngine } from "./psx";
import { ptmToWavEngine } from "./ptm";
import { qoiToPngEngine } from "./qoi";
import { radToWavEngine } from "./rad";
import { rasToPngEngine } from "./ras";
import { rawToPngEngine } from "./raw";
...
import { rppToJsonEngine } from "./rpp";
import { rtfToMarkdownEngine } from "./rtf";
import { rtfdToMarkdownEngine } from "./rtfd";
import { s3mToWavEngine } from "./s3m";
import { smiToSrtEngine } from "./sami";
import { savToZipEngine } from "./sav";
import { sbvToSrtEngine } from "./sbv";
import { sccToSrtEngine } from "./scc";
import { scormToZipEngine } from "./scorm";
import { scrivToMarkdownEngine } from "./scriv";
import { sdwToMarkdownEngine } from "./sdw";
import { sgiToPngEngine } from "./sgi";
import { shpToGeoJsonEngine } from "./shp";
import { silkToWavEngine } from "./silk";
import { sketchToPngEngine } from "./sketch";
import { solToJsonEngine } from "./sol";
import { sf2ToWavEngine } from "./soundfont";
import { sqliteToZipEngine } from "./sqlite";
import { srfToPngEngine } from "./srf";
import { srtToVttEngine } from "./srt";
import { stlToSrtEngine } from "./stl";
import { stmToWavEngine } from "./stm";
import { studio3ToSvgEngine } from "./studio";
import { styToMidEngine } from "./sty";
import { svgOptimiseEngine } from "./svg/optimise";
import { svgSpriteSheetEngine } from "./svg/sprite-sheet";
import { svgzToSvgEngine } from "./svgz";
import { sxwToMarkdownEngine } from "./sxw";
import { tcxToGeoJsonEngine } from "./tcx";
import { telegramToMarkdownEngine } from "./telegram";
import { texinfoToMarkdownEngine } from "./texinfo";
import { tgaToPngEngine } from "./tga";
import { tgsToJsonEngine } from "./tgs";
import { thmToJpgEngine } from "./thm";
import { ti8xpToTxtEngine } from "./ti8xp";
import { timToPngEngine } from "./tim";
import { torrentToJsonEngine } from "./torrent";
import { troffToMarkdownEngine } from "./troff";
import type { Engine } from "./types";
import { ulawToWavEngine } from "./ulaw";
import { ultToWavEngine } from "./ult";
import { vagToWavEngine } from "./vag";
import { vcdToCsvEngine } from "./vcd";
import { vcfToCsvEngine } from "./vcf";
import { vdaToPngEngine } from "./vda";
...
import { vmsToPngEngine } from "./vms";
...
import { walToPngEngine } from "./wal";
import { pkgToMp4Engine } from "./wallpaper";
import { webArchiveToHtmlEngine } from "./webarchive";
import { weblocToUrlEngine } from "./webloc";
import { whatsappToMarkdownEngine } from "./whatsapp";
import { wmfToSvgEngine } from "./wmf";
import { xbmToPngEngine } from "./xbm";
import { xcurToPngEngine } from "./xcur";
import { xdToPngEngine } from "./xd";
import { xmToWavEngine } from "./xm";
import { xmiToWavEngine } from "./xmi";
import { xmindToMarkdownEngine } from "./xmind";
import { xp3ToZipEngine } from "./xp3";
import { xpmToPngEngine } from "./xpm";
import { xptToCsvEngine } from "./xpt";
import { xwdToPngEngine } from "./xwd";
import { zabwToMarkdownEngine } from "./zabw";
...
function buildImageEngines(): Map<string, Engine> {
	...
	engines.set(svgSpriteSheetEngine.id, svgSpriteSheetEngine);
	...
	engines.set(thmToJpgEngine.id, thmToJpgEngine);
	...
	engines.set(sbvToSrtEngine.id, sbvToSrtEngine);
	...
	engines.set(arrowToCsvEngine.id, arrowToCsvEngine);
	...
	engines.set(canvasToMarkdownEngine.id, canvasToMarkdownEngine);
	...
	engines.set(savToZipEngine.id, savToZipEngine);
	engines.set(gbrToPngEngine.id, gbrToPngEngine);
	engines.set(gpmfToCsvEngine.id, gpmfToCsvEngine);
	engines.set(gpkgToGeoJsonEngine.id, gpkgToGeoJsonEngine);
	engines.set(cdrToPngEngine.id, cdrToPngEngine);
	engines.set(cbtToPdfEngine.id, cbtToPdfEngine);
	engines.set(cb7ToPdfEngine.id, cb7ToPdfEngine);
	engines.set(cbrToPdfEngine.id, cbrToPdfEngine);
	...
	engines.set(sqliteToZipEngine.id, sqliteToZipEngine);
	engines.set(sketchToPngEngine.id, sketchToPngEngine);
	engines.set(stlToSrtEngine.id, stlToSrtEngine);
	engines.set(stmToWavEngine.id, stmToWavEngine);
	engines.set(actToCssEngine.id, actToCssEngine);
	engines.set(alsToJsonEngine.id, alsToJsonEngine);
	...
	engines.set(xdToPngEngine.id, xdToPngEngine);
	...
	engines.set(xptToCsvEngine.id, xptToCsvEngine);
	...
	engines.set(telegramToMarkdownEngine.id, telegramToMarkdownEngine);
	engines.set(ircamToWavEngine.id, ircamToWavEngine);
	engines.set(isoToZipEngine.id, isoToZipEngine);
	engines.set(sgiToPngEngine.id, sgiToPngEngine);
	engines.set(shpToGeoJsonEngine.id, shpToGeoJsonEngine);
	...
	engines.set(dstToSvgEngine.id, dstToSvgEngine);
	engines.set(dtaToZipEngine.id, dtaToZipEngine);
	engines.set(djiToCsvEngine.id, djiToCsvEngine);
	engines.set(drawioToSvgEngine.id, drawioToSvgEngine);
	...
	engines.set(parquetToCsvEngine.id, parquetToCsvEngine);
	...
	engines.set(icsToCsvEngine.id, icsToCsvEngine);
	...
	engines.set(torrentToJsonEngine.id, torrentToJsonEngine);
	engines.set(rtfToMarkdownEngine.id, rtfToMarkdownEngine);
	engines.set(dspToWavEngine.id, dspToWavEngine);
	engines.set(emlxToEmlEngine.id, emlxToEmlEngine);
	engines.set(emlToTxtEngine.id, emlToTxtEngine);
	...
	engines.set(ultToWavEngine.id, ultToWavEngine);
	engines.set(zxToPngEngine.id, zxToPngEngine);
	engines.set(koaToPngEngine.id, koaToPngEngine);
	engines.set(kraToPngEngine.id, kraToPngEngine);
	...
	engines.set(cgmToSvgEngine.id, cgmToSvgEngine);
	engines.set(s3mToWavEngine.id, s3mToWavEngine);
	engines.set(enexToMarkdownEngine.id, enexToMarkdownEngine);
	engines.set(excalidrawToSvgEngine.id, excalidrawToSvgEngine);
	engines.set(expToSvgEngine.id, expToSvgEngine);
	engines.set(itToWavEngine.id, itToWavEngine);
	engines.set(iworkPreviewToZipEngine.id, iworkPreviewToZipEngine);
	engines.set(jefToSvgEngine.id, jefToSvgEngine);
	engines.set(fb2ToMarkdownEngine.id, fb2ToMarkdownEngine);
	engines.set(flicToGifEngine.id, flicToGifEngine);
	engines.set(qoiToPngEngine.id, qoiToPngEngine);
	engines.set(opmlToMarkdownEngine.id, opmlToMarkdownEngine);
	engines.set(oraToPngEngine.id, oraToPngEngine);
	engines.set(ptmToWavEngine.id, ptmToWavEngine);
	engines.set(psdToPngEngine.id, psdToPngEngine);
	...
	engines.set(amfToWavEngine.id, amfToWavEngine);
	engines.set(cwkToMarkdownEngine.id, cwkToMarkdownEngine);
	engines.set(cpcToPngEngine.id, cpcToPngEngine);
	engines.set(dsmToWavEngine.id, dsmToWavEngine);
	engines.set(sxwToMarkdownEngine.id, sxwToMarkdownEngine);
	engines.set(xcurToPngEngine.id, xcurToPngEngine);
	engines.set(radToWavEngine.id, radToWavEngine);
	engines.set(sdwToMarkdownEngine.id, sdwToMarkdownEngine);
	engines.set(dbfToCsvEngine.id, dbfToCsvEngine);
	engines.set(bpgToPngEngine.id, bpgToPngEngine);
	engines.set(oktToWavEngine.id, oktToWavEngine);
	engines.set(ofxToCsvEngine.id, ofxToCsvEngine);
	engines.set(zabwToMarkdownEngine.id, zabwToMarkdownEngine);
	engines.set(blpToPngEngine.id, blpToPngEngine);
	engines.set(mtmToWavEngine.id, mtmToWavEngine);
	engines.set(rtfdToMarkdownEngine.id, rtfdToMarkdownEngine);
	engines.set(scrivToMarkdownEngine.id, scrivToMarkdownEngine);
	engines.set(vdaToPngEngine.id, vdaToPngEngine);
	engines.set(amrToWavEngine.id, amrToWavEngine);
	engines.set(nbToMarkdownEngine.id, nbToMarkdownEngine);
	engines.set(walToPngEngine.id, walToPngEngine);
	engines.set(whatsappToMarkdownEngine.id, whatsappToMarkdownEngine);
	engines.set(imfToWavEngine.id, imfToWavEngine);
	engines.set(lyxToMarkdownEngine.id, lyxToMarkdownEngine);
	engines.set(lrvToMp4Engine.id, lrvToMp4Engine);
	engines.set(lrcToSrtEngine.id, lrcToSrtEngine);
	engines.set(ldifToCsvEngine.id, ldifToCsvEngine);
	engines.set(srfToPngEngine.id, srfToPngEngine);
	...
	engines.set(mmapToMarkdownEngine.id, mmapToMarkdownEngine);
	engines.set(rolToWavEngine.id, rolToWavEngine);
	engines.set(manToMarkdownEngine.id, manToMarkdownEngine);
	engines.set(mboxToZipEngine.id, mboxToZipEngine);
	engines.set(matToZipEngine.id, matToZipEngine);
	engines.set(mobiToMarkdownEngine.id, mobiToMarkdownEngine);
	engines.set(pcdToPngEngine.id, pcdToPngEngine);
	engines.set(xmiToWavEngine.id, xmiToWavEngine);
	engines.set(troffToMarkdownEngine.id, troffToMarkdownEngine);
	engines.set(discordToMarkdownEngine.id, discordToMarkdownEngine);
	engines.set(rawToPngEngine.id, rawToPngEngine);
	engines.set(rppToJsonEngine.id, rppToJsonEngine);
	engines.set(solToJsonEngine.id, solToJsonEngine);
	engines.set(styToMidEngine.id, styToMidEngine);
	engines.set(ti8xpToTxtEngine.id, ti8xpToTxtEngine);
	engines.set(weblocToUrlEngine.id, weblocToUrlEngine);
	engines.set(adifToCsvEngine.id, adifToCsvEngine);
	engines.set(igcToGpxEngine.id, igcToGpxEngine);
	engines.set(nscriptToTxtEngine.id, nscriptToTxtEngine);
	engines.set(pltToSvgEngine.id, pltToSvgEngine);
	engines.set(ascToCsvEngine.id, ascToCsvEngine);
	engines.set(gciToJsonEngine.id, gciToJsonEngine);
	engines.set(mcrToZipEngine.id, mcrToZipEngine);
	engines.set(sccToSrtEngine.id, sccToSrtEngine);
	engines.set(vcdToCsvEngine.id, vcdToCsvEngine);
	engines.set(ndsToPngEngine.id, ndsToPngEngine);
	engines.set(xp3ToZipEngine.id, xp3ToZipEngine);
	engines.set(bupToZipEngine.id, bupToZipEngine);
	engines.set(vmsToPngEngine.id, vmsToPngEngine);
	engines.set(gbToPngEngine.id, gbToPngEngine);
	engines.set(psuToZipEngine.id, psuToZipEngine);
	engines.set(cifToJsonEngine.id, cifToJsonEngine);
	{
	...
	for (const from of ["avi", "flv", "wmv", "dav", "h264", "vro"] as const) {
...
export { adifToCsvEngine } from "./adif";
export { aiffToWavEngine } from "./aiff";
export { alsToJsonEngine } from "./als";
export { amfToWavEngine } from "./amf";
export { amrToWavEngine } from "./amr";
export { aniToPngEngine } from "./ani";
export { arrowToCsvEngine } from "./arrow";
export { artStudioToPngEngine } from "./artstudio";
export { ascToCsvEngine } from "./asc";
...
export { blpToPngEngine } from "./blp";
export { bpgToPngEngine } from "./bpg";
export { bspToZipEngine } from "./bsp";
export { bupToZipEngine } from "./bup";
export { cafToWavEngine } from "./caf";
export { cb7ToPdfEngine } from "./cb7";
export { cbrToPdfEngine } from "./cbr";
export { cbtToPdfEngine } from "./cbt";
export { cbzToPdfEngine } from "./cbz";
export { cdrToPngEngine } from "./cdr";
export { cgmToSvgEngine } from "./cgm";
export { chmToZipEngine } from "./chm";
export { chrToPngEngine } from "./chr";
export { cifToJsonEngine } from "./cif";
export { cpcToPngEngine } from "./cpc";
export { cueToJsonEngine } from "./cue";
export { cwkToMarkdownEngine } from "./cwk";
export { dbfToCsvEngine } from "./dbf";
export { dcmToPngEngine } from "./dcm";
export { degasToPngEngine } from "./degas";
export { discordToMarkdownEngine } from "./discord";
export { djiToCsvEngine } from "./dji";
export { drawioToSvgEngine } from "./drawio";
export { dsfToWavEngine } from "./dsf";
export { dsmToWavEngine } from "./dsm";
export { dstToSvgEngine } from "./dst";
export { dtaToZipEngine } from "./dta";
export { dxfToSvgEngine } from "./dxf";
export { emlToTxtEngine } from "./eml";
export { emlxToEmlEngine } from "./emlx";
export { enexToMarkdownEngine } from "./enex";
export { epubToMarkdownEngine } from "./epub";
export { excalidrawToSvgEngine } from "./excalidraw";
export { expToSvgEngine } from "./exp";
export { farToWavEngine } from "./far";
export { fb2ToMarkdownEngine } from "./fb2";
export { fitsToPngEngine } from "./fits";
export { gbToPngEngine } from "./gb";
export { gbrToPngEngine } from "./gbr";
export { gciToJsonEngine } from "./gci";
export { gedcomToCsvEngine } from "./gedcom";
export { gmlToGeoJsonEngine } from "./gml";
export { gpkgToGeoJsonEngine } from "./gpkg";
export { gpmfToCsvEngine } from "./gpmf";
export { gpxToGeoJsonEngine } from "./gpx";
export { hdrToPngEngine } from "./hdr";
export { hmiToWavEngine } from "./hmi";
export { hwpToMarkdownEngine } from "./hwp";
export { icoToPngEngine } from "./ico";
export { icsToCsvEngine } from "./ics";
export { iffToPngEngine } from "./iff";
export { igcToGpxEngine } from "./igc";
export { imfToWavEngine } from "./imf";
export { ircamToWavEngine } from "./ircam";
export { isoToZipEngine } from "./iso";
export { itToWavEngine } from "./it";
export { iworkPreviewToZipEngine } from "./iwork";
export { jefToSvgEngine } from "./jef";
export { canvasToMarkdownEngine } from "./jsoncanvas";
export { kmlToGeoJsonEngine } from "./kml";
export { kmzToGeoJsonEngine } from "./kmz";
export { koaToPngEngine } from "./koa";
export { kraToPngEngine } from "./kra";
export { ldifToCsvEngine } from "./ldif";
export { lrcToSrtEngine } from "./lrc";
export { lrvToMp4Engine } from "./lrv";
export { lyxToMarkdownEngine } from "./lyx";
export { manToMarkdownEngine } from "./man";
export { matToZipEngine } from "./mat";
export { mboxToZipEngine } from "./mbox";
export { microDvdToSrtEngine } from "./microdvd";
export { mmapToMarkdownEngine } from "./mmap";
export { mngToPngEngine } from "./mng";
export { mobiToMarkdownEngine } from "./mobi";
export { modToWavEngine } from "./mod";
export { mtmToWavEngine } from "./mtm";
export { nbToMarkdownEngine } from "./nb";
export { ndsToPngEngine } from "./nds";
export { neoToPngEngine } from "./neo";
export { nfoToHtmlEngine } from "./nfo";
export { nistToWavEngine } from "./nist";
export { nscriptToTxtEngine } from "./nscript";
export { ofxToCsvEngine } from "./ofx";
export { oktToWavEngine } from "./okt";
export { opmlToMarkdownEngine } from "./opml";
export { oraToPngEngine } from "./ora";
export { orgToMarkdownEngine } from "./org";
export { osmToGeoJsonEngine } from "./osm";
export { palmdocToMarkdownEngine } from "./palmdoc";
export { parquetToCsvEngine } from "./parquet";
export { pcdToPngEngine } from "./pcd";
export { pcxToPngEngine } from "./pcx";
export { pltToSvgEngine } from "./plt";
export { ppmToPngEngine } from "./ppm";
export { psdToPngEngine } from "./psd";
export { psuToZipEngine } from "./psu";
export { mcrToZipEngine } from "./psx";
export { ptmToWavEngine } from "./ptm";
export { qoiToPngEngine } from "./qoi";
export { radToWavEngine } from "./rad";
export { rasToPngEngine } from "./ras";
export { rawToPngEngine } from "./raw";
export { rolToWavEngine } from "./rol";
export { rppToJsonEngine } from "./rpp";
export { rtfdToMarkdownEngine } from "./rtfd";
export { s3mToWavEngine } from "./s3m";
export { smiToSrtEngine } from "./sami";
export { savToZipEngine } from "./sav";
export { sbvToSrtEngine } from "./sbv";
export { sccToSrtEngine } from "./scc";
export { sdwToMarkdownEngine } from "./sdw";
export { sgiToPngEngine } from "./sgi";
export { shpToGeoJsonEngine } from "./shp";
export { silkToWavEngine } from "./silk";
export { sketchToPngEngine } from "./sketch";
export { solToJsonEngine } from "./sol";
export { sqliteToZipEngine } from "./sqlite";
export { srfToPngEngine } from "./srf";
export { srtToVttEngine } from "./srt";
export { stlToSrtEngine } from "./stl";
export { stmToWavEngine } from "./stm";
export { styToMidEngine } from "./sty";
export { svgzToSvgEngine } from "./svgz";
export { sxwToMarkdownEngine } from "./sxw";
export { tcxToGeoJsonEngine } from "./tcx";
export { telegramToMarkdownEngine } from "./telegram";
export { texinfoToMarkdownEngine } from "./texinfo";
export { tgaToPngEngine } from "./tga";
export { thmToJpgEngine } from "./thm";
export { ti8xpToTxtEngine } from "./ti8xp";
export { torrentToJsonEngine } from "./torrent";
export { troffToMarkdownEngine } from "./troff";
export { ulawToWavEngine } from "./ulaw";
export { ultToWavEngine } from "./ult";
export { vagToWavEngine } from "./vag";
export { vcdToCsvEngine } from "./vcd";
export { vdaToPngEngine } from "./vda";
export { vmsToPngEngine } from "./vms";
export { vocToWavEngine } from "./voc";
export { vtfToPngEngine } from "./vtf";
export { vttToSrtEngine } from "./vtt";
export { walToPngEngine } from "./wal";
export { weblocToUrlEngine } from "./webloc";
export { whatsappToMarkdownEngine } from "./whatsapp";
export { wmfToSvgEngine } from "./wmf";
export { xbmToPngEngine } from "./xbm";
export { xcurToPngEngine } from "./xcur";
export { xdToPngEngine } from "./xd";
export { xmToWavEngine } from "./xm";
export { xmiToWavEngine } from "./xmi";
export { xp3ToZipEngine } from "./xp3";
export { xpmToPngEngine } from "./xpm";
export { xptToCsvEngine } from "./xpt";
export { xwdToPngEngine } from "./xwd";
export { zabwToMarkdownEngine } from "./zabw";
