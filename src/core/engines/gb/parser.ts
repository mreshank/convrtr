...
const ROM_SIZES: Record<number, { bytes: number; label: string }> = {
	0x00: { bytes: 32 * 1024, label: "32 KB (2 banks)" },
	0x01: { bytes: 64 * 1024, label: "64 KB (4 banks)" },
	0x02: { bytes: 128 * 1024, label: "128 KB (8 banks)" },
	0x03: { bytes: 256 * 1024, label: "256 KB (16 banks)" },
	0x04: { bytes: 512 * 1024, label: "512 KB (32 banks)" },
	0x05: { bytes: 1024 * 1024, label: "1 MB (64 banks)" },
	0x06: { bytes: 2 * 1024 * 1024, label: "2 MB (128 banks)" },
	0x07: { bytes: 4 * 1024 * 1024, label: "4 MB (256 banks)" },
	0x08: { bytes: 8 * 1024 * 1024, label: "8 MB (512 banks)" },
};

const RAM_SIZES: Record<number, { bytes: number; label: string }> = {
	0x00: { bytes: 0, label: "None" },
	0x01: { bytes: 2 * 1024, label: "2 KB" },
	0x02: { bytes: 8 * 1024, label: "8 KB (1 bank)" },
	0x03: { bytes: 32 * 1024, label: "32 KB (4 banks of 8KB)" },
	0x04: { bytes: 128 * 1024, label: "128 KB (16 banks of 8KB)" },
	0x05: { bytes: 64 * 1024, label: "64 KB (8 banks of 8KB)" },
};
