import type { SectionsPageContent } from "./types";
 ...
 */
export const privacyPolicy: SectionsPageContent = {
	title: "Privacy Policy",
	updated: "9 September 2026",
	sections: [
		{
			heading: "Overview",
			body: `This Privacy Policy describes how convrtr ("the Service")
		...
		},
		{
			...
			body: `None. convrtr does not operate a server that stores, logs, or
		...
		},
		{
			...
			body: `convrtr stores a small amount of state on your own device,
		...
		},
		{
			...
			body: `The Service does not set cookies and does not use analytics,
			advertising, or tracking technology of any kind.`,
		},
		{
			heading: "Third Parties",
			body: `None receive your files or any data about them. Every
		...
		},
		{
			...
			body: `Because the Service collects no personal information from
			anyone, it collects none from children either.`,
		},
		{
			heading: "Changes to This Policy",
			body: `The revision date above reflects the last change. Any future
		...
		},
		{
			...
			body: `PLACEHOLDER — pending the project owner's input. A privacy
