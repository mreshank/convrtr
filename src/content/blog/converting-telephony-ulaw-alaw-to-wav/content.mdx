...
1. **μ-law (PCMU / Mu-Law)**: Primarily used in North America (USA, Canada) and Japan. It uses a logarithmic curve defined by parameter μ = 255, offering slightly better dynamic range for quiet speech.
