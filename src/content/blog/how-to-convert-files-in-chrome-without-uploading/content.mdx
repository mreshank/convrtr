...
### 3. Visible Viewport Capture
Need to extract a visual reference, code block, or dashboard metric?

- Press `Command+Shift+S` (or `Ctrl+Shift+S`) or select **Capture visible page** from the context menu.
- The extension takes a high-fidelity capture of your current tab viewport and stages it immediately into tools like [PNG to WebP](/image/png-to-webp) or [JPG to PDF](/document/jpg-to-pdf).
- Zero third-party screenshot software required.
...
| `activeTab` | Grants temporary permission to capture the visible tab or stage media upon an explicit user gesture (`Command+Shift+S` or context menu click). |
